...
const navItems: NavItem[] = [
  ...
  },
  {
    ...
    to: '/wallet',
    labelKey: 'nav.wallet',
    roles: [USER_ROLES.SUPER_ADMIN, USER_ROLES.TENANT_ADMIN, USER_ROLES.FINANCE],
    icon: IconWallet,
  },
  {
    groupKey: 'navGroups.tenant',
...
const routeRoles: Record<string, UserRole[]> = {
  ...
  '/wallet': [USER_ROLES.SUPER_ADMIN, USER_ROLES.TENANT_ADMIN, USER_ROLES.FINANCE],
  '/wallet/transactions': [USER_ROLES.SUPER_ADMIN, USER_ROLES.TENANT_ADMIN, USER_ROLES.FINANCE],
